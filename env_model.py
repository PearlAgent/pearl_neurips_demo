...
class SequenceClassificationModel(nn.Module):
    ...
    def forward(self, x, action):
        ...
        h0 = self.default_hidden_representation.unsqueeze(1).repeat(1, batch_size, 1).detach()
        c0 = self.default_cell_representation.unsqueeze(1).repeat(1, batch_size, 1).detach()
